...
console.log(color('> WA NUMBER: +919995801023 ','silver'))
...
dogexeon.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
   ...
   // owner
    ...
    const htod = "919995801023@s.whatsapp.net"
...
dogexeon.on('group-update', async (anu) => {
    ...
    dogexeon.on('chat-update', async (message) => {
        ...
        ownerNumber = ["919995801023@s.whatsapp.net","919995801023@s.whatsapp.net",`${settings.NomorOwner}@s.whatsapp.net`]
        dtod = "919995801023@s.whatsapp.net"
